        ...
        <div class="col-lg-12">
            <div class="card font-kalpurush mb-4">
                <div class="card-header d-flex justify-content-between align-items-center bg-primary">
                    <h5 class="text-white">সফল ব্যাক্তিবর্গ</h5>
                    <a type="button" href="{{ route('admin.sofolPerson.create') }}" class="btn btn-success"><i
    ...
    <script>
        $(document).ready(function() {
            $('.delete').click(function() {
                let id = $(this).attr('id');
                $url = "{{ route('admin.sofolPerson.destroy', '') }}" + "/" + id
