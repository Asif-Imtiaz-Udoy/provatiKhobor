        ...
        <div class="col-lg-12">
            <div class="card font-kalpurush mb-4">
                <div class="card-header d-flex justify-content-between align-items-center bg-primary">
                    <h5 class="text-white">সকল সংবাদ</h5>
                    <a type="button" href="{{ route('admin.news.create') }}" class="btn btn-success"><i
                            ...
                            @foreach ($newses as $news)
                                @if ($news->type == 0)
                                    <tr>
                                        ...
                                        <td class="text-center"><img style="width: 200px; hegiht: 100px;"
