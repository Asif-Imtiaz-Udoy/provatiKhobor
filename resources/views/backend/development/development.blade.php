        ...
        <div class="col-lg-12">
            <div class="card font-kalpurush mb-4">
                <div class="card-header d-flex justify-content-between align-items-center bg-primary">
                    <h5 class="text-white">উন্নয়নের অংশীদার সংবাদ</h5>
                    <a type="button" href="{{ route('admin.development.create') }}" class="btn btn-success"><i
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a class="btn btn-sm btn-link text-primary"
                                                href="{{ route('admin.development.edit', $news->id) }}"><i
